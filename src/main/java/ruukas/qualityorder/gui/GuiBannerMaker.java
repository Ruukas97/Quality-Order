...
public class GuiBannerMaker extends InventoryEffectRenderer {
	...
	private static final ResourceLocation background = new ResourceLocation(QualityOrder.MODID, "textures/gui/bannermaker.png");
	...
	public GuiBannerMaker(EntityPlayer player) {
	...
	private void updateBanners(List<ItemStack> stackList) {
		...
		if (currentBanner == null || currentBanner == ItemStack.EMPTY) {
			...
			stackList.add(AlphabetSkulls.getAlphabetSkull('p'));
			stackList.add(AlphabetSkulls.getAlphabetSkull('i'));
			stackList.add(AlphabetSkulls.getAlphabetSkull('c'));
			stackList.add(AlphabetSkulls.getAlphabetSkull('k'));

			stackList.add(ItemStack.EMPTY);

			stackList.add(AlphabetSkulls.getAlphabetSkull('c'));
			stackList.add(AlphabetSkulls.getAlphabetSkull('o'));
			stackList.add(AlphabetSkulls.getAlphabetSkull('l'));
			stackList.add(AlphabetSkulls.getAlphabetSkull('o'));
			stackList.add(AlphabetSkulls.getAlphabetSkull('r'));
}
		else {
	...
	/**
	 * Called every time the list should change (mostly if the currentbanner
	 * changes).
	 * 
	...
	/**
	 * Changes the current banner into a shield - or back to a banner, if it is
	 * already a shield.
	 */
	...
	/**
	 * Sets the current banner to an ItemStack. And sends an "update list"
	 * request.
	 * 
	 * @param banner
	...
	protected void keyTyped(char typedChar, int keyCode) throws IOException {
		...
		if (keyCode == 1) {
			this.mc.displayGuiScreen((GuiScreen) new GuiContainerCreative(Minecraft.getMinecraft().player));
		}
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if (getCurrentBanner() == null || getCurrentBanner() == ItemStack.EMPTY) {
			...
			if (getCurrentBanner().getItem() == Items.BANNER) {
				...
				GuiHelper.renderBanner(this.guiLeft + 164, this.guiTop + 103, 20, (float) (this.guiLeft + 175 - mouseX), (float) (this.guiTop + 103 - 30 - mouseY), bannerTe);
			}
			else {
				...
				GuiHelper.drawEntityOnScreen(this.guiLeft + 169, this.guiTop + 103, 18, (float) (this.guiLeft + 145 - mouseX), (float) (this.guiTop + 103 - 30 - mouseY), armorStand);
			}
